...
SELECT setval('"public"."attachment_id_seq"', 28630, true);
...
SELECT setval('"public"."block_id_seq"', 240, true);
...
SELECT setval('"public"."file_id_seq"', 12962, true);
...
SELECT setval('"public"."messages_id_seq"', 460961, true);
...
SELECT setval('"public"."user_id_seq"', 126, true);
